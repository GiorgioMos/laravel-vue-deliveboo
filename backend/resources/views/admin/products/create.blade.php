        ...
        <div class="col-6">
            ...
            <form action="{{ route("admin.products.store") }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error("name") is-invalid @enderror" id="name" name="name" value="{{ old("name") }}" required onkeyup="validateName()">
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control @error("description") is-invalid @enderror" id="description" name="description" value="{{ old("description") }}" required minlength="10" max="255" onkeyup="validateDescription()"></textarea>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error("price") is-invalid @enderror" id="price" name="price" value="{{ old("price") }}" min="0.01" max="999.99" step="0.01" required onkeyup="validatePrice()">
                ...
                <div class="mb-3">
                    <div class="row">
                        <div class="col-1">
                            ...
                            <input type="hidden" class="form-check-input @error(" visible") is-invalid @enderror" id="visible-hidden" name="visible" value="0">
                            <input type="checkbox" class="form-check-input @error(" visible") is-invalid @enderror" id="visible" name="visible" value="1" onchange="validateVisible()">
